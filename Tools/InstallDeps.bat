...
if exist "..\Build\deps" (
    if not exist "..\Build\deps\deps.v4.txt" (
        ...
        echo Deleting Stones2Stars DLL dependencies, please wait for the process to complete...
        rmdir /Q /S "..\Build\deps"

        echo Unpacking Stones2Stars DLL dependencies, please wait for the process to complete...
